...
nohup java -server -Xms128m -Xmx128m -XX:MaxDirectMemorySize=512m -XX:+UseConcMarkSweepGC -XX:+PrintGCDetails -XX:+PrintGCTimeStamps $KRB5_OPTS -Duser.timezone=UTC -Dfile.encoding=UTF-8 -Djava.io.tmpdir=/data/druid/cluster_6/broker/tmps -classpath /data/druid/cluster_6/_common/conf:/data/druid/cluster_6/broker/conf:/app/druid-0.7.3/lib/* io.druid.cli.Main server broker > /dev/null 2>&1 &
